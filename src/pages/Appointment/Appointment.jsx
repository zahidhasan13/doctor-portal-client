...
const Appointment = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:mx-48 lg: my-20">
        <div>
      ...
      <div>
        {selectDate && (
          <h4 className="text-2xl font-medium text-[#19D3AE] text-center">
            Available Services on {`${dayOfWeek} ${day} ${month} ${year}`}
          </h4>
        )}
      </div>
